  ...
  return (
    <>
      ...
      <aside
        ...
        `}
      >
        <div className="flex items-center justify-between px-4 h-16 border-b-2 border-black shrink-0">
          <h2 className="font-heading text-sm text-foreground/60 uppercase tracking-wider">
            Riwayat
          </h2>
          <button
            onClick={onClose}
            className="md:hidden p-1.5 rounded-lg text-foreground/30 hover:text-foreground transition-colors"
          >
            <X size={18} />
          </button>
        </div>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[10px] text-foreground/30 mt-0.5">
                    {s.messages.length > 0
                      ? `${s.messages.length} pesan · ${formatDate(s.createdAt)}`
                      : 'Kosong'}
                  </p>
                </div>
                <button
        ...
        {sessions.length > 0 && (
          <div className="px-3 pb-3 border-t-2 border-black pt-3">
            <button
